...
class orsay_about_author extends WP_Widget
{
	function __construct(){

		$widget_ops = array('classname' => 'orsay-about-author','description' => esc_html__( "Widget to author" ,'orsay') );
		parent::__construct('orsay_about_author', esc_html__('Orsay About Author','orsay'), $widget_ops);
	...
	function widget($args , $instance) {
		...
		$title = isset($instance['title']) ? esc_html( $instance['title'] ) : esc_html__('About Me', 'orsay');
		...
		$attachment_style = $instance[ 'attachment_style' ] ? 'true' : 'true';
		...
		if( $name != '' ) {
			...
			if ($attachment_id != "") {
				...
				$imageSizeName = "orsay-author-thumbnail";
		...
		?>
			...
			<div class="author-item">
				<div class="author-image">
					<img src="<?php echo $imgsrc; ?>" alt="<?php echo esc_attr($name); ?>" class="img-responsive <?php echo $attachment_css; ?>" />
				</div>
				<div class="author-post">
					...
					<p class="read-more"><a href="<?php echo esc_url($more_text_url); ?>">More...</a></p>
				</div>
			</div>
	...
	?>
		...
		<p><label for="Title"><?php esc_html_e('Title ','orsay') ?></label>
		...
		<p><label for="Name"><?php esc_html_e('Name ','orsay') ?></label>
		...
		<p><label for="position"><?php esc_html_e('Position ','orsay') ?></label>
		...
		<p><label for="<?php echo $this->get_field_id('body_content'); ?>"><?php esc_html_e('Content ','orsay') ?></label>
		...
		<p><label for="more_text_url"><?php esc_html_e('Link to more info ','orsay') ?></label>
		...
		<p><label for="attachment_style"><?php esc_html_e('Rounded Author Image? ','orsay') ?></label>
		...
		<p style="overflow: auto;">
			<!-- Image Thumbnail -->
			<a href="#" class="button custom_media_upload">Upload Image</a>
